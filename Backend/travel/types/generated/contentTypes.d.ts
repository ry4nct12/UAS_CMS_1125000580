...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    booking_code: Schema.Attribute.UID<'customer_name'> &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status_trx: Schema.Attribute.Enumeration<['pending', 'paid', 'cancel']> &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    destinasi: Schema.Attribute.Relation<
      'oneToOne',
      'api::destinasi.destinasi'
    >;
    destinasis: Schema.Attribute.Relation<
      'oneToMany',
      'api::destinasi.destinasi'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
